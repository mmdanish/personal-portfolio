...
import { FolderOpen, Globe, Mail, Moon, Sparkles, Sun } from 'lucide-react'
import { siGithub, siInstagram } from 'simple-icons'
import { aboutContent, education, experience, exploring, personalInfo, projects, skills } from '@/data/portfolio'

function BrandIcon({ path }: { path: string }) {
  return <svg viewBox="0 0 24 24" aria-hidden="true" focusable="false" fill="currentColor"><path d={path} /></svg>
}
